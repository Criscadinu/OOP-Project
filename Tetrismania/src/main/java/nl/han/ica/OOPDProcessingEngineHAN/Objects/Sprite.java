...
/**
 * The Sprite object is used in the GameEngine and is a wrapper for the PImage
 * object from the Processing library.
 */
public class Sprite {
	 ...
	 */
	/*
	 * public Sprite(String fileName) { this(SpriteHelper.loadImage(fileName)); }
	 */
...
//    }
	...
	/**
	 * The SpriteHelper is a helper class which is only be used to load images from
	 * a file. This is necessarily because Processing doesn't allow any other way.
	 */
