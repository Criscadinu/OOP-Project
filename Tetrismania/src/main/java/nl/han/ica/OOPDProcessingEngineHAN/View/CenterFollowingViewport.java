...
/**
 * This class allows following a GameObject in the Viewport. The Viewport will
 * move if the followed GameObject if the maximum tolerance in a certain
 * direction from its center is reached.
 */
public class CenterFollowingViewport extends FollowingViewport {
	...
	/**
	 * The distance in pixels on the x axis where the center of the followed object
	 * is from the center of the Viewport.
	 */
	protected double xOffset;

	/**
	 * The distance in pixels on the y axis where the center of the followed object
	 * is from the center of the Viewport.
	 */
	 ...
	 * @param zoomHeight     The height in pixels which the viewPort will cut out of
	 *                       the world.
	 * @param xOffset        The distance in pixels on the x axis where the center
	 *                       of the followed object is from the center of the
	 *                       Viewport
	 * @param yOffset        The distance in pixels on the y axis where the center
	 *                       of the followed object is from the center of the
	 *                       Viewport
	 */
	public CenterFollowingViewport(GameObject followedObject, int zoomWidth, int zoomHeight, double xOffset,
			double yOffset) {
	 ...
	 * 
	 * @param worldGraphics The canvas which represents the world from which the
	 *                      viewPort will cut its image out of.
	 ...
	 * Sets the offset.
	 * 
	 * @param xOffset The distance in pixels on the x axis where the center of the
	 *                followed object is from the center of the Viewport
	 * @param yOffset The distance in pixels on the y axis where the center of the
	 *                followed object is from the center of the Viewport
	 */
	 ...
	 * Gets the x offset.
	 * 
	 * @return The distance in pixels on the x axis where the center of the followed
	 *         object is from the center of the Viewport
	 */
	 ...
	 * Gets the y offset.
	 * 
	 * @return The distance in pixels on the y axis where the center of the followed
	 *         object is from the center of the Viewport
	 */
