...
public class FilePersistence implements IPersistence {
	...
	/**
	 * The constructor allows you to specify the filename the internal storage will
	 * use.
	 *
	...
	/**
	 * Saves the data to the earlier specified file. All previous saved data will be
	 * overwritten. You can get your previous data by loading it first and then
	 * appending your new data to the String.
	 *
	 * @param data The data that should be saved to the file, the data must be one
	 *             entire String.
	 */
	 ...
	 * function will return the data or an empty String if the file does not exist,
	...
	/**
	 *
	 * @param separator The specific String which is used to separate the String
	 *                  from the earlier specified file.
	 * @return The generated Array made out of the String from the earlier specified
	 *         file.
	 */
