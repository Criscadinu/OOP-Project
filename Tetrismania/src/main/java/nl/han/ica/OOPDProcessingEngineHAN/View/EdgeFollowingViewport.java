...
/**
 * This class allows following an GameObject in the Viewport. The viewport will
 * move if the followed GameObject reaches the side of the viewport minus the
 * given tolerance.
 */
public class EdgeFollowingViewport extends FollowingViewport {
	 ...
	 *                       Viewport
	 */
	public EdgeFollowingViewport(GameObject followedObject, int zoomWidth, int zoomHeight, double xOffset,
			double yOffset) {
