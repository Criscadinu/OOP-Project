...
/**
 * This interface is used to implement in objects that need to listen to the
 * GameEngine mouse input.
 */
public interface IMouseInput {
	 ...
	 * 
	 * @param x The x value is the relative mouse position calculated with the
	 *          position of the world (TileMap).
	 * @param y The y value is the relative mouse position calculated with the
	 *          position of the world (TileMap).
	 */
