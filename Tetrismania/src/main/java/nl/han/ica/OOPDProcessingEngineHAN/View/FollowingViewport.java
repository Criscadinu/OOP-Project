...
/**
 * Extend this class if you want to make your own following viewport
 * implementation.
 */
public abstract class FollowingViewport extends Viewport {
	...
	/**
	 * The tolerance of the top side the object has to move before the viewport
	 * moves with it.
	 */
	protected int topTolerance;

	/**
	 * The tolerance of the bottom side the object has to move before the viewport
	 * moves with it.
	 */
	protected int bottomTolerance;

	/**
	 * The tolerance of the left side the object has to move before the viewport
	 * moves with it.
	 */
	protected int leftTolerance;

	/**
	 * The tolerance of the right side the object has to move before the viewport
	 * moves with it.
	 */
	 ...
	 * @param zoomWidth      The width in pixels which the viewPort will cut out of
	 *                       the world.
	 * @param zoomHeight     The height in pixels which the viewPort will cut out of
	 *                       the world.
	 */
	 ...
	 * 
	 * @param top    The tolerance op the top side the object has to move before the
	 *               Viewport moves with it.
	 * @param bottom The tolerance op the bottom side the object has to move before
	 *               the Viewport moves with it.
	 * @param left   The tolerance op the left side the object has to move before
	 *               the Viewport moves with it.
	 * @param right  The tolerance op the right side the object has to move before
	 *               the Viewport moves with it.
	 */
	 ...
	 * 
	 * @return The tolerance op the top side the object has to move before the
	 *         viewport moves with it.
	 */
	 ...
	 * 
	 * @param topTolerance The tolerance op the top side the object has to move
	 *                     before the viewport moves with it.
	 */
	 ...
	 * 
	 * @return The tolerance op the bottom side the object has to move before the
	 *         viewport moves with it.
	 */
	 ...
	 * 
	 * @param bottomTolerance The tolerance op the bottom side the object has to
	 *                        move before the viewport moves with it.
	 */
	 ...
	 * 
	 * @return The tolerance op the Left side the object has to move before the
	 *         viewport moves with it.
	 */
	 ...
	 * 
	 * @param leftTolerance The tolerance op the left side the object has to move
	 *                      before the viewport moves with it.
	 */
	 ...
	 * 
	 * @param rightTolerance The tolerance op the left side the object has to move
	 *                       before the viewport moves with it.
	 */
