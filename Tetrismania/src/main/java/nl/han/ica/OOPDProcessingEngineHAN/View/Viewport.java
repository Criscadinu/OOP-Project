...
public class Viewport {
	...
	/**
	 * The x index of the topLeft corner from where the viewPort will cut its image
	 * out of the world.
	 */
	protected Integer x;

	/**
	 * The y index of the topLeft corner from where the viewPort will cut its image
	 * out of the world.
	 */
	protected Integer y;
	 ...
	 * 
	 * @param x          The x index of the topLeft corner from where the viewPort
	 *                   will cut its image out of the world.
	 * @param y          The y index of the topLeft corner from where the viewPort
	 *                   will cut its image out of the world.
	 * @param zoomWidth  The width in pixels which the viewPort will cut out of the
	 *                   world.
	 * @param zoomHeight The height in pixels which the viewPort will cut out of the
	 *                   world.
	 */
	 ...
	 * 
	 * @return The x index of the topLeft corner from where the viewPort will cut
	 *         its image out of the world.
	 */
	public Integer getX() {
		return x;
	}
	 ...
	 * 
	 * @param x The x index of the topLeft corner from where the viewPort will cut
	 *          its image out of the world.
	 */
	 ...
	 * 
	 * @return The y index of the topLeft corner from where the viewPort will cut
	 *         its image out of the world.
	 */
	public Integer getY() {
		return y;
	 ...
	 * 
	 * @param y The y index of the topLeft corner from where the viewPort will cut
	 *          its image out of the world.
	 */
	 ...
	 * 
	 * @param width The width in pixels which the viewPort will cut out of the
	 *              world.
	 */
