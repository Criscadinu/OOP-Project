...
public class TileMap {
	 ...
	 * @param tileTypes The Array with factory's which will be creating the
	 *                  different types of tiles.
	 * @param indexMap  The Map consisting of tileType indexes which will be used to
	...
	/**
	 * Resize the tiles currently used in the map and sets the tileSize for new
	 * Tile.
	 * 
	 * @param tileSize The size the tiles will be.
	 */
	 ...
	 * 
	 * @param indexMap The two dimensional int array which contains the indexes of
	 *                 the tileTypes.
	 */
	 ...
	 * Gets the TileMap.
	 * 
	 * @return The two dimensional int array which contains the indexes of the
	 *         tileTypes.
	 */
	...
	/**
	 * Sets the TileTypes of the TileMap and adjusts the current map to the new
	 * Types
	 * 
	 ...
	 * @return An PVector which contains the indexes of the Tile on the x and y axis
	 *         of the tileMap.
	 * @throws TileNotFoundException Is being thrown when the given tile is not
	 *                               present in the current tileMap.
	 */
