...
public class View {
	...
	/**
	 * Basic constructor of the View which creates its own viewPort which shows the
	 * entire world.
	 *
	 * @param worldWidth  The width of the world in which all the objects will be
	 *                    drawn.
	 * @param worldHeight The height of the world in which all the objects will be
	 *                    drawn.
	 */
	 ...
	 * 
	 * @param viewport    The instance of viewPort which generates what is shown of
	 *                    the world
	 * @param worldWidth  The width of the world in which all the objects will be
	 *                    drawn.
	 * @param worldHeight The height of the world in which all the objects will be
	...
	/**
	 * The main draw method of the engine. It will be called by de engine and
	 * handles calling all the draw methods of the objects it gets in the
	 * parameters. It also handles the generation of the Viewport.
	 *
	 * @param g           The canvas on which the view will be drawn.
	 * @param tileMap     The instance of tileMap which will be drawn after the
	 *                    background and before the gameObjects and the generation
	 *                    of the viewPort
	 * @param gameObjects The array with instances of gameObjects which will be
	 *                    drawn after the tileMap and before the viewport is
	 *                    generated
	 * @param dashboards  The array with instances of dashboards which will be drawn
	 *                    after the viewport is generated
	 */
	...
	/**
	 * Sets the size of the world which will be the canvas all the objects will be
	 * drawn on before the viewPort is generated.
	 * 
	 * @param worldWidth  The width of the world in which all the objects will be
	 *                    drawn.
	 * @param worldHeight The height of the world in which all the objects will be
	...
	/**
	 * Sets the background color of your game in RGB format which is used in the
	 * draw method.
	 * 
	 * @param r Red.
	 * @param g Green.
