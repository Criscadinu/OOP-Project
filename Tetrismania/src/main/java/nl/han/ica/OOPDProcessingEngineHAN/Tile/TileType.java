...
/**
 * This factory creates new instances of the class the programmer specifies in
 * the constructor.
 * 
...
public class TileType<T extends Tile> {
	...
	/**
	 * The image which will be drawn whenever the draw method of the created tiles
	 * is called.
	 */
	 ...
	 * 
	 * @param classType The type of class this factory will be creating instances
	 *                  of.
	 * @param sprite    The image which will be drawn whenever the draw method of
	 *                  the created tiles is called.
	 */
	...
	/**
	 * This method returns new instances of the class which is specified in the
	 * constructor.
	 * 
	 * @param tileSize the size of the Tile which wil be used to resize the image of
	 *                 the Tile.
	 * @return Tile
	 */
